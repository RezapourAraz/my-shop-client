...
const CardStepper = () => {
  return (
    <div className="md:container md:mx-auto py-10 overflow-x-auto">
      <div className="mb-8">
      ...
      <div className="flex justify-between">
        <div className="p-2 border-b-2 w-full border-gray-500">
          <div className="flex gap-2 ">
            ...
            <h5 className="text-lg font-bold text-nowrap">SHOPPING BAG</h5>
          </div>
          <div>
        ...
        <div className="p-2 border-b-2 w-full border-gray-500">
          <div className="flex gap-2">
            ...
            <h5 className="text-lg font-bold text-nowrap">
        ...
        <div className="p-2 border-b-2 w-full border-gray-500">
          <div className="flex gap-2">
            ...
            <h5 className="text-lg font-bold text-nowrap">CONFIRMATION</h5>
          </div>
          <div>
